...
#define Hal_TFTLCD_LED_Clear()		GPIO_ResetBits(TFTLCD_LEDA_EN_PORT, TFTLCD_LEDA_EN_PIN)
#define Hal_TFTLCD_LED_Set()		GPIO_SetBits(TFTLCD_LEDA_EN_PORT, TFTLCD_LEDA_EN_PIN)
